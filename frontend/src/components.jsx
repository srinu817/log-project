        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="formGrid">
            <div className="formField">
              ...
              >
                {t(
                  "Username cannot be changed from the profile screen."
                )}
              </span>
            </div>
          ...
          <div className="smtpNotice">
            ...
            <span>
              {t(
                "Your role and account status are managed separately and cannot be changed here."
              )}
            </span>
          </div>
      ...
      <div className="modal repositoryWizardModal">
        <div className="modalHeader repositoryWizardHeader">
          <div>
            ...
            <span>
              {t(
                "Follow the steps to configure your repository."
              )}
            </span>
          </div>
            ...
            <div className="repositoryWizardPanel">
              <div className="repositoryWizardPanelHeader">
                ...
                <div>
                  ...
                  <p>
                    {t(
                      "Configure how Log Delivery authenticates with the repository."
                    )}
                  </p>
                </div>
              </div>
              ...
              {isLocal ? (
                <div className="smtpNotice">
                  ...
                  <span>
                    {t(
                      "Local Git repositories do not require remote authentication."
                    )}
                  </span>
                </div>
              ) : (
                    ...
                    >
                      <div className="formField">
                        ...
                        <input
                          ...
                          placeholder={t("frontend/src/logs")}
                          required
                        />
                      </div>
            ...
            <div className="repositoryWizardPanel">
              <div className="repositoryWizardPanelHeader">
                ...
                <div>
                  ...
                  <p>
                    {t(
                      "Configure recipients and delivery method."
                    )}
                  </p>
                </div>
              </div>
              ...
              {form.email_mode ===
                ...
                <div className="smtpNotice">
                  ...
                  <span>
                    {t(
                      "SMTP delivery is enabled. The configured archive will be sent to the recipients after a successful run."
                    )}
                  </span>
                </div>
              )}
                ...
                onTestConnection && (
                  ...
                  >
                    ...
                    {!editing && (
                      <span>
                        {t(
                          "Save the repository first to test the connection."
                        )}
                      </span>
                    )}
                  </div>
            ...
            <div className="repositoryWizardPanel">
              <div className="repositoryWizardPanelHeader">
                ...
                <div>
                  ...
                  <p>
                    {t(
                      "Please review your repository configuration before saving."
                    )}
                  </p>
                </div>
              </div>
        ...
        {!isActive && (
          <>
            ...
            <button
              ...
              disabled
              title={t(
                "Deactivated repositories cannot be tested."
              )}
            >
              <Wifi size={14} />
              {t("Test")}
    ...
    <div className="modalOverlay">
      <div className="deliveryModal auditLogDetailModal">
        ...
        <div className="resultGrid">
          <ResultItem icon={Users} label="User" value={log.username || log.user?.username || "System"} />
          <ResultItem icon={IdCard} label="User ID" value={log.user_id || log.user?.id || "—"} />
          <ResultItem icon={ListChecks} label="Action" value={String(log.action || "UNKNOWN").replaceAll("_", " ")} />
          <ResultItem icon={FolderGit2} label="Resource" value={log.resource || "—"} />
          <ResultItem icon={FileText} label="Resource ID" value={log.resource_id || "—"} mono />
          <ResultItem icon={Globe2} label="IP Address" value={log.ip_address || "—"} mono />
          <ResultItem icon={CalendarDays} label="Timestamp" value={log.timestamp ? new Date(log.timestamp).toLocaleString() : "—"} />
          <ResultItem icon={Server} label="Source" value={log.source || "—"} />
        </div>
